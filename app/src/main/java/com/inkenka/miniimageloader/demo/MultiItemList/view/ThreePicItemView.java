    ...
    public void bindData(Object object) {
        if (object instanceof ListItemData) {
            ...
            if (!TextUtils.isEmpty(pic1Url) && !TextUtils.isEmpty(pic2Url) && !TextUtils
                ...
                MiniImageLoader.get(getContext()).loadImage(pic1Url, mPic1View);
                MiniImageLoader.get(getContext()).loadImage(pic1Url, mPic2View);
                MiniImageLoader.get(getContext()).loadImage(pic1Url, mPic3View);
            } else {
                mTextView.setText("");
